...
class GFJeebFormData
{
    ...
    public function __construct(&$form)
    {
        if (false === isset($form) || true === empty($form)) {
            error_log('[ERROR] In GFJeebFormData::__construct(): Missing or invalid $form parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $form parameter in the GFJeebFormData::__construct() function.');
        }
    ...
    {
        if (false === isset($form) || true === empty($form)) {
            error_log('[ERROR] In GFJeebFormData::loadForm(): Missing or invalid $form parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $form parameter in the GFJeebFormData::loadForm() function.');
        }
    ...
    {
        if (false === isset($form) || true === empty($form)) {
            error_log('[ERROR] In GFJeebFormData::getProductPrice(): Missing or invalid $form parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $form parameter in the GFJeebFormData::getProductPrice() function.');
        }

        if (false === isset($field) || true === empty($field)) {
            error_log('[ERROR] In GFJeebFormData::getProductPrice(): Missing or invalid $field parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $field parameter in the GFJeebFormData::getProductPrice() function.');
        }
    ...
    {
        if (false === isset($form) || true === empty($form)) {
            error_log('[ERROR] In GFJeebFormData::getShipping(): Missing or invalid $form parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $form parameter in the GFJeebFormData::getShipping() function.');
        }

        if (false === isset($field) || true === empty($field)) {
            error_log('[ERROR] In GFJeebFormData::getShipping(): Missing or invalid $field parameter.');
            throw new \Exception('An error occurred in the Jeeb Payment plugin: Missing or invalid $field parameter in the GFJeebFormData::getShipping() function.');
        }
